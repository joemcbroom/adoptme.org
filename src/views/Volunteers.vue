<template>
  <div class="volunteers container-fluid pt-4">
    ...
    <sign-up :apiURL="apiURL" @axiosShowVolunteers="axiosShowVolunteers()" />
    <div class="row justify-content-center align-items-stretch">
      ...
      >
        <div class="card">
          ...
          >
            <span class="title-span px-1">{{ volunteer.name }}</span>
          </h5>
          <div class="card-body p-2">
            <p>
              <img class="avatar mt-2" :src="volunteer.avatar" />
            </p>
            <p class="quote">
              Favorite Quote:
...
export default {
  ...
  data() {
    return {
      apiURL: "http://5dee5bd2b3d17b00146a2776.mockapi.io/api/volunteers",
      volunteers: []
    };
  },
  methods: {
